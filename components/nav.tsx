...
function Navbar() {
  return (
    <header className="text-gray-600 body-font bg-white">
      <div className="container mt-6 2xl:mt-8 mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
          <Image
            ...
            width={50}
          ></Image>
          <span className="ml-4 text-base 2xl:text-xl">
            Port. <br></br> Bandit
          </span>
        </a>

        <nav className="md:ml-auto md:mr-auto flex ml-6 flex-wrap items-center text-base justify-center">
          <a href="#">
